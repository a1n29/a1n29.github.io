function init() {
  ...
  // Load the CSV file
  d3.csv("csv/departure.csv").then(function (csvData) {
    // Format the data
  ...
  function lineChart(dataset, state) {
    ...
    d3.select(".lineChart2").selectAll("svg").remove();
    ...
    svg.selectAll(".dot")
      ...
      .on("mouseover", function (d) {
        ...
        tooltip.style("visibility", "visible")
          .html("Departures: " + departure.toLocaleString());
        ...
        var xOffset = tooltipWidth + 375;
        var yOffset = -(tooltipHeight + 725);
