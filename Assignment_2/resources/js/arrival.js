function init() {
  ...
  d3.csv("resources/data/arrivals.csv").then(function (csvData) {
  ...
  function lineChart(dataset, state) {
    ...
    svg.selectAll(".dot")
      ...
      .on("mouseover", function (d) {
        ...
        var xOffset = tooltipWidth - 175;
        var yOffset = -(tooltipHeight + 700);
    ...
    svg.append("text")
      ...
      .style("font-size", "14px")
      .style("font-weight", "bold")
      .text("Total number of Arrival migrants");
